...
public class Action extends BaseClass{
	...
	public static boolean findElement(WebDriver getDriver, WebElement ele) {
		boolean flag = false;
		try {
			ele.isDisplayed();
			flag = true;
	...
	public static void waitTillElementDisplay(WebDriver driver, WebElement ele) {
	...
	public static void enterNum(WebElement ele, int num) {
	    ele.sendKeys(String.valueOf(num)); // Convert int to String
	}
